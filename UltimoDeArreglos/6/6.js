/*Dado los arreglos valle = [“Cali” , “Tulua”, “Cartago”, “Salento”] quindio = [“Cordoba”,
    ...
    function ordenarCiudades() {
        ...
        for (let i = 0; i < valle.length; i++) {
          if (valle[i] === "Cali" || valle[i] === "Tulua") {
            valle2.push(valle[i]);
          }
          if (valle[i] === "Cartago" || valle[i] === "Palmira") {
            quindio2.push(valle[i]);
          }
        }
        
        for (let i = 0; i < quindio.length; i++) {
          if (quindio[i] === "Cordoba" || quindio[i] === "Armenia") {
            quindio2.push(quindio[i]);
          }
          if (quindio[i] === "Salento" || quindio[i] === "Circasia") {
            valle2.push(quindio[i]);
          }
        }
